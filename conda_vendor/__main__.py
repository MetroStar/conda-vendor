...
class CommandLocalYaml:
    ...
    def print(environment_yml, local_environment_name=None):
        conda_channel = CondaChannel(environment_yml)
        local_yaml = get_local_environment_yaml(conda_channel,
    ...
    def create(environment_yml,
        ...
        conda_channel = CondaChannel(environment_yml)
        create_local_environment_yaml(conda_channel,
                local_environment_name=local_environment_name,
...
class CommandLocalChannels:
    ...
    def create(environment_yml, *,
        ...
        create_local_channels(conda_channel,
    ...
    def configure_parser(self, parser):
        ...
        parser.add_argument('-f', '--file', type=str,
            help='environment.yaml file')
        parser.add_argument('--channel-root', type=str,
